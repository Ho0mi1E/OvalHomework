    ...
    init {
        context.theme.obtainStyledAttributes(attrs, R.styleable.OvalView, 0, 0)
            .apply {
                ...
                ovalColor = getColor(R.styleable.OvalView_ovalColor,context.getColor(R.color.purple_700))
                linesColor = getColor(R.styleable.OvalView_linesColor,context.getColor(R.color.white))
            }
    }
